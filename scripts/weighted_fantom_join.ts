...
async function join() {
  ...
  const POOL_ID = '0x7086355713F5B148E5891CDEEC35CB49176AEC9B0002000000000000000007F0';
  const tokens = [
    { ...TOKENS['FANTOM'].SGOAT, balance: parseUnits('0.12', TOKENS['FANTOM'].SGOAT.decimals) },
