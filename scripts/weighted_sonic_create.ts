...
async function create() {
  ...
  const poolSymbol = 'bpt-beets-sts';
  const swapFee = 1; // as true percentage 0.04 => 0.04%
  const random = '0xca798ecc26480efbc233475ee4c2bad59cbfcbd347721987a3b5b8e5ce14bcc8'; // https://www.browserling.com/tools/random-hex
