...
async function join() {
  ...
  const poolId = '0xd2efc016650695c56b514d6a2133ad85afb86d8a00000000000000000000009e';
  const poolAddress = '0xd2efc016650695c56b514d6a2133ad85afb86d8a';
  ...
  const tokens = [
    ...
    {
      ...TOKENS['SONIC'].WOS,
      balance: parseUnits('0.5', TOKENS['SONIC'].WOS.decimals),
    },
    {
      address: poolAddress,
