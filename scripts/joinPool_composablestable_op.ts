...
const POOL_ADDRESS = '0x7FE29a818438Ed2759e30f65c2302295711d66Fc';
...
const poolId = '0x7fe29a818438ed2759e30f65c2302295711d66fc0000000000000000000000e5';
...
async function join() {
  ...
  const tokens = [
    ...
    },
    {
      name: 'bbrfUSDT',
      address: bbrfUSDT,
      balance: parseUnits('0.999999311879368535', 18),
    },
  ];
